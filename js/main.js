...
function initI18n() {
  ...
  const dict = {
    en: {
      ...
      "cta-title": "Talk with us on WeChat, WhatsApp, or email",
      "cta-subtext": "Scan the QR code below to reach us directly on WeChat or WhatsApp for pricing, deployment, and integration questions, or email us at info@voltmindai.com.",
      "cta-wechat-note": "Add us on WeChat and say hello — we’ll respond shortly.",
      "cta-whatsapp-note": "Scan on WhatsApp to start a chat with our team for product and deployment support.",
      "cta-email-label": "Email",
      "cta-email-note": "Send us your project details and we will reply with pricing, integration, and deployment support.",
    ...
    zh: {
      ...
      "cta-label": "立即聯絡",
      "cta-title": "透過 WeChat、WhatsApp 或 Email 與我們聯繫",
      "cta-subtext": "掃描下方 QR Code 加我們的 WeChat 或 WhatsApp，詢問價格、部署與整合；也可直接電郵至 info@voltmindai.com。",
      "cta-wechat-note": "在 WeChat 上留言，我們會盡快回覆。",
      "cta-whatsapp-note": "使用 WhatsApp 掃描 QR Code，即可直接與我們聯繫產品與部署支援。",
      "cta-email-label": "電郵",
      "cta-email-note": "把您的專案需求寄給我們，我們會回覆報價、整合方式與部署支援。",
